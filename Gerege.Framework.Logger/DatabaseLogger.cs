...
namespace Gerege.Framework.Logger
{
    ...
    public abstract class DatabaseLogger
    {
        ...
        protected abstract void Log(string table, string level, string message, object context);
        ...
        /// <param name="message">Тайлбар мессеж.</param>
        /// <param name="context">Өгөгдөл.</param>
        public void Notice(string table, string message, object context) => Log(table, "notice", message, context);
        ...
        /// <param name="message">Тайлбар мессеж.</param>
        /// <param name="context">Өгөгдөл.</param>
        public void Info(string table, string message, object context) => Log(table, "info", message, context);
        ...
        /// <param name="message">Тайлбар мессеж.</param>
        /// <param name="context">Өгөгдөл.</param>
        public void Error(string table, string message, object context) => Log(table, "error", message, context);
        ...
        /// <param name="message">Тайлбар мессеж.</param>
        /// <param name="context">Өгөгдөл.</param>
        public void Warning(string table, string message, object context) => Log(table, "warning", message, context);
        ...
        /// <param name="message">Тайлбар мессеж.</param>
        /// <param name="context">Өгөгдөл.</param>
        public void Emergency(string table, string message, object context) => Log(table, "emergency", message, context);
        ...
        /// <param name="message">Тайлбар мессеж.</param>
        /// <param name="context">Өгөгдөл.</param>
        public void Alert(string table, string message, object context) => Log(table, "alert", message, context);
        ...
        /// <param name="message">Тайлбар мессеж.</param>
        /// <param name="context">Өгөгдөл.</param>
        public void Сritical(string table, string message, object context) => Log(table, "critical", message, context);
        ...
        /// <param name="message">Тайлбар мессеж.</param>
        /// <param name="context">Өгөгдөл.</param>
        public void Trace(string table, string message, object context) => Log(table, "trace", message, context);
    }
}
